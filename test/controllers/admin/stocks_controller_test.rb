...
class Admin::StocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_stock" do
    assert_difference("Admin::Stock.count") do
      post admin_stocks_url, params: { admin_stock: { amount: @admin_stock.amount, product_id_id: @admin_stock.product_id_id, size: @admin_stock.size } }
    end
  ...
  test "should update admin_stock" do
    patch admin_stock_url(@admin_stock), params: { admin_stock: { amount: @admin_stock.amount, product_id_id: @admin_stock.product_id_id, size: @admin_stock.size } }
